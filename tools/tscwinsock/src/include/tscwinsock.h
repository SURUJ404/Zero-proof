...
*/
//=======================================================
#ifndef TSCWINSOCK_WRAPPER
#define TSCWINSOCK_WRAPPER
...
namespace __TSCSOCKET__ {
	...
	bool					__createserver(TSCSERVER * const & server_class, PCSTR port, int protocol, FPC_CALLBACK fpConnected, FPS_CALLBACK fpData);
