...
#define					TSCSOCKET_PREFIX				"TSCSOCKET:"
#define					TSCSOCKET_CLIENT_PREFIX		"TSCSOCKET CLIENT:"

#ifndef DEFAULT_BUFF
	#define				DEFAULT_BUFF					512
#endif

#define					TSCLIENT						__TSCSOCKET__::Client
#define					LPTSCLIENT						__TSCSOCKET__::Client *
#define					TSCSERVER						__TSCSOCKET__::Server
#define					LPTSCSERVER						__TSCSOCKET__::Server *
