...
import (
	...
	"tsc-wireshift-web/internal/storage"
...
func (r *Resender) CreateNewTab(newTabData map[string]interface{}) error {
	...
	if !ok {
		...
		defaultRequest = map[string]interface{}{
			...
			"requestBody":     `{"tool": "tsc-wireshift", "test": "This is a test request", "timestamp": "2024"}`,
	...
	wailsruntime.EventsEmit(r.ctx, "backend:newTabCreated", map[string]interface{}{
		"tabId":     tabID,
		"requestId": requestId,
	})
...
func (r *Resender) SendRequest(tabId float64, requestDetails map[string]interface{}) error {
	...
	if err != nil {
		...
		wailsruntime.EventsEmit(r.ctx, "backend:resenderResponse", map[string]interface{}{
			"error": err.Error(),
			"tabId": tabId,
		})
		return err
	...
	// Skip storing tsc-wireshift requests
	if strings.Contains(strings.ToLower(domain), "tsc-wireshift") {
		return nil
	}
...
func (r *Resender) UpdateTabName(tabID int, newName string) error {
	...
	wailsruntime.EventsEmit(r.ctx, "backend:tabNameUpdated", map[string]interface{}{
		"tabId":   tabID,
		"newName": newName,
	})
...
func (r *Resender) DeleteTab(tabID int) error {
	...
	wailsruntime.EventsEmit(r.ctx, "backend:tabDeleted", map[string]interface{}{
		"success": true,
		"tabId":   tabID,
	})
...
func (r *Resender) GetRequest(requestID int) error {
	...
	wailsruntime.EventsEmit(r.ctx, "backend:resenderRequest", map[string]interface{}{
		"id":              requestID,
		"url":             url,
		"method":          method,
