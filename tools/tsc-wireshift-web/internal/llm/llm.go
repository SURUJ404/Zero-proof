...
func (c *Client) SendMessage(messageData map[string]interface{}, settings map[string]interface{}) error {
	...
	if !ok {
		wailsruntime.EventsEmit(c.ctx, "backend:error", map[string]interface{}{
	...
	if len(chatGPTResponse.Choices) > 0 {
		...
		wailsruntime.EventsEmit(c.ctx, "backend:receiveMessage", map[string]interface{}{
...
func (c *Client) CreateChatContext(requestString string) (int64, error) {
	...
	wailsruntime.EventsEmit(c.ctx, "backend:chatContextCreated", map[string]interface{}{
		"id":   id,
		"name": newChatName,
	})
...
func (c *Client) DeleteChatContext(chatContextId int) error {
	...
	wailsruntime.EventsEmit(c.ctx, "backend:chatContextDeleted", map[string]interface{}{
		"id": chatContextId,
	})
...
func (c *Client) EditChatContextName(chatContextId int, newName string) error {
	...
	wailsruntime.EventsEmit(c.ctx, "backend:chatContextNameUpdated", map[string]interface{}{
		"id":      chatContextId,
		"newName": newName,
	})
