...
import (
	...
	"tsc-wireshift-web/internal/certificate"

	"crypto/tls"

	"github.com/elazarl/goproxy"
	"github.com/google/uuid"
	wailsRuntime "tsc-wireshift-web/internal/wailsruntime"
)
...
func (p *Proxy) SetupHandlers() {
	// Handler for tsc-wireshift domain to serve root CA
	p.ProxyServer.OnRequest(goproxy.DstHostIs("tsc-wireshift")).DoFunc(
