...
<head>
  ...
  <title>${result.projectName} — Attack Surface Report</title>
  <style>
    :root {
      --bg: #0d1117;
      --surface: #161b22;
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .service-type {
      ...
      border-radius: 4px; background: var(--primary-dark); color: white;
    ...
    .tag {
      ...
      border-radius: 3px; background: rgba(255,255,255,0.08); margin: 0.1rem;
    }
...
<body>
  <div class="header">
    ...
    <p class="subtitle">Attack Surface Report · ${result.totalEndpoints} endpoints discovered · ${result.scannedAt}</p>
    <div class="stats">
      <div class="stat"><div class="stat-value">${result.totalEndpoints}</div><div class="stat-label">Total Endpoints</div></div>
      ...
      <div class="stat"><div class="stat-value">${result.tags.prover || 0}</div><div class="stat-label">Prover Endpoints</div></div>
    </div>
  </div>
  ...
  <div class="footer">
    Generated by <strong>zero-noir</strong> v1.0.0 — Zero Proof Attack Surface Detector
  </div>
</body>
</html>`;
  }
