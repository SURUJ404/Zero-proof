...
<body>
  <div class="header">
    ...
    <p class="subtitle">Attack Surface Report · ${result.totalEndpoints} endpoints · ${result.services.length} services · ${result.clis.length} CLI tools</p>
  ...
  <div class="footer">
    Generated by <strong>ScanDog</strong> v1.0.0 — Code and infrastructure attack surface detector
  </div>
</body>
</html>`;
  }
