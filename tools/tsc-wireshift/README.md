...
<a href="https://github.com/al-sultani/tsc-wireshift"><img src="/build/appicon.png" width="128" alt="TSC Wireshift"></a>
...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](https://github.com/al-sultani/tsc-wireshift/)
[![GitHub Issues](https://img.shields.io/github/issues/al-sultani/tsc-wireshift.svg?style=flat-square)](https://github.com/al-sultani/tsc-wireshift/issues)
[![GitHub Stars](https://img.shields.io/github/stars/al-sultani/tsc-wireshift.svg?style=flat-square)](https://github.com/al-sultani/tsc-wireshift/stargazers)
...
<!-- Change to GIF -->
![TSC Wireshift Screenshot](docs/screenshots/1.png)

</div>

## <a id="features"></a> âœ¨ Features

- ðŸ” Intercept and analyze HTTP/HTTPS traffic
- ðŸš€ Built with Go and React for maximum performance
- ðŸ’» Modern and intuitive user interface
- ðŸ›  Powerful traffic manipulation tools
- ðŸŒ“ Dark and light theme support
- ðŸ”„ Request resender for quick retesting
- ðŸ§ª Fuzzer for security testing and vulnerability discovery
- ðŸª Interactsh integration for out-of-band testing
- ðŸ¤– AI-powered analysis with ChatGPT integration
...
3. Launch TSC Wireshift

## <a id="usage"></a> ðŸŽ¯ Usage

* [User Guide](/docs/USER_GUIDE.md)

## <a id="development"></a> ðŸ’» Development
...
## <a id="docker-support"></a> ðŸ³ Docker Support
...
## <a id="issues"></a> ðŸ› Issues and Feedback
...
To submit an issue, please visit our [Issues page](https://github.com/al-sultani/tsc-wireshift/issues) and provide as much detail as possible to help us understand and address your concerns.

## <a id="roadmap"></a> ðŸ—ºï¸ Roadmap

Check out our [Roadmap](/docs/ROADMAP.md) to see what features and improvements are planned for future releases.

## <a id="license"></a> ðŸ“ License
...
- âŒ Prohibits commercial resale
- âŒ Prohibits selling the software as a service

See the [LICENSE](LICENSE) file for the complete terms.

## <a id="author"></a> ðŸ‘¨â€ðŸ’» Author
