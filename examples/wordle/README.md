...
In addition, the server returns a [receipt](https://www.github.com/SURUJ404/Zero-proof/docs/explainers/proof-system/) that attests to the logic of the letter-checking and [includes the hash](methods/guest/src/main.rs) of the secret word.
...
Then, the `check_receipt` function checks that the hash in the [journal contents](https://www.github.com/SURUJ404/Zero-proof/docs/explainers/zkvm/) match the hash of the secret word provided at the start of the game.
