...
This code demonstrates how to provably compute the SHA-256 hash of a string using Zero Proof.
...
- We show two ways of calling the hash function:
  ...
  - Either approach will use the Zero Proof SHA-256 accelerator in the zkVM guest, which has _much_ higher performance than any software implementation.
...
Thanks to Pawel from [Discord](https://) for creating and sharing this content!
