...
[`env::commit_slice`]: https://docs.rs/risc0-zkvm/1.2/risc0_zkvm/guest/env/fn.commit_slice.html
[`env::commit`]: https://docs.rs/risc0-zkvm/1.2/risc0_zkvm/guest/env/fn.commit.html
[`env::cycle_count`]: https://docs.rs/risc0-zkvm/1.2/risc0_zkvm/guest/env/fn.cycle_count.html
[`env::log`]: https://docs.rs/risc0-zkvm/1.2/risc0_zkvm/guest/env/fn.log.html
...
[`env::stderr`]: https://docs.rs/risc0-zkvm/1.2/risc0_zkvm/guest/env/fn.stderr.html
[`env::stdin`]: https://docs.rs/risc0-zkvm/1.2/risc0_zkvm/guest/env/fn.stdin.html
...
[template]: https://github.com/risc0/risc0/tree/release-1.2/risc0/cargo-risczero/templates/rust-starter
