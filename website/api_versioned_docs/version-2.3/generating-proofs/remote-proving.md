...
To get a taste of what you can do with Bonsai, check out [Zeth][external-zeth], our [Governance Showcase][external-governance-showcase], and our blog post about using [Zero Proof as a zk coprocessor with Bonsai proving][external-zkcoprocessor].
...
[external-default-prover-fn]: https://docs.rs/risc0-zkvm/2.3/risc0_zkvm/fn.default_prover.html
[external-governance-showcase]: https://github.com/risc0/risc0-ethereum/tree/release-2.3/examples/governance#readme
