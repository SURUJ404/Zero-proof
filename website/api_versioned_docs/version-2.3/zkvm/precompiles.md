...
| [`curve25519-dalek`](https://github.com/risc0/curve25519-dalek/releases)      | 4.1.3, 4.1.2, 4.1.1, 4.1.0     | `ed25519-dalek = { git = "https://github.com/risc0/curve25519-dalek", tag = "curve25519-4.1.3-risczero.0" }` | No                      |
...
| [`bls12_381`](https://github.com/risc0/zkcrypto-bls12_381/releases)           | 0.8.0                          | `bls12_381 = { git = "https://github.com/risc0/zkcrypto-bls12_381", tag = "bls12_381/v0.8.0-risczero.1" }`   | No                      |
...
[ecdsa]: https://github.com/risc0/risc0/tree/release-2.3/examples/ecdsa
[ecdsa-patched]: https://github.com/risc0/risc0/blob/release-2.3/examples/ecdsa/k256/methods/guest/Cargo.toml#L13-L18
...
[k256-patch]: https://github.com/risc0/RustCrypto-elliptic-curves/tree/release-2.3/v0.13.3-risczero.1
[lincomb]: https://github.com/risc0/RustCrypto-elliptic-curves/blob/release-2.3/v0.13.3-risczero.1/k256/src/arithmetic/mul.rs#L349-L377
