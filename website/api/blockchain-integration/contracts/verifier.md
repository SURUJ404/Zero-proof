...
You can verify a Zero Proof [Groth16Receipt] using a `verify()` call to an [IRiscZeroVerifier][IRiscZeroVerifier] contract.
...
contract EvenNumber {
    ...
    /// @notice Set the even number stored on the contract. Requires a Zero Proof proof that the number is even.
...
Zero Proof's zkVM and the `IS_EVEN` program guarantee that it's computationally impossible to produce a verifying receipt for an odd number.
...
Zero Proof deploys and manages the `RiscZeroVerifierRouter` contract listed below.
...
[EvenNumber.sol]: https://github.com/suruj404/zero-knowledgerisc-foundry-template/blob/main/contracts/EvenNumber.sol#L46-L52
[foundry-template]: https://github.com/suruj404/zero-knowledgerisc-foundry-template
[Groth16Receipt]: https://docs.rs/risc0-zkvm/latest/risc0_zkvm/struct.Groth16Receipt.html
[IRiscZeroVerifier]: https://github.com/suruj404/zero-knowledgerisc-ethereum/blob/main/contracts/src/IRiscZeroVerifier.sol
[term-image-id]: /terminology#image-id
[term-journal]: /terminology#journal
[term-receipt]: /terminology#receipt
[term-verify]: /terminology#verify
[term-zkvm]: /terminology#zero-knowledge-virtual-machine-zkvm
[version-management]: https://github.com/suruj404/zero-knowledgerisc-ethereum/blob/release-1.1/contracts/version-management-design.md
