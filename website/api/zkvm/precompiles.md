...
| ----------------------------------------------------------------------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| [`sha2`](https://github.com/suruj404/zero-knowledgeriscRustCrypto-hashes/releases)                 | 0.10.9, 0.10.8, 0.10.7, 0.10.6, 0.9.9 | `sha2 = { git = "https://github.com/suruj404/zero-knowledgeriscRustCrypto-hashes", tag = "sha2-v0.10.9-risczero.0" }`             |
| [`tiny-keccak`](https://github.com/suruj404/zero-knowledgerisctiny-keccak/releases)                | 2.0.2                                 | `tiny-keccak = { git = "https://github.com/suruj404/zero-knowledgerisctiny-keccak", tag = "tiny-keccak/v2.0.2-risczero.0" }`      |
| [`k256`](https://github.com/suruj404/zero-knowledgeriscRustCrypto-elliptic-curves/releases)        | 0.13.4, 0.13.3, 0.13.2, 0.13.1        | `k256 = { git = "https://github.com/suruj404/zero-knowledgeriscRustCrypto-elliptic-curves", tag = "k256/v0.13.4-risczero.1" }`    |
| [`p256`](https://github.com/suruj404/zero-knowledgeriscRustCrypto-elliptic-curves/releases)        | 0.13.2                                | `p256 = { git = "https://github.com/suruj404/zero-knowledgeriscRustCrypto-elliptic-curves", tag = "p256/v0.13.2-risczero.1" }`    |
| [`curve25519-dalek`](https://github.com/suruj404/zero-knowledgerisccurve25519-dalek/releases)      | 4.1.3, 4.1.2, 4.1.1, 4.1.0            | `ed25519-dalek = { git = "https://github.com/suruj404/zero-knowledgerisccurve25519-dalek", tag = "curve25519-4.1.3-risczero.0" }` |
| [`rsa`](https://github.com/suruj404/zero-knowledgeriscRustCrypto-RSA/releases)                     | 0.9.9                                 | `rsa = { git = "https://github.com/suruj404/zero-knowledgeriscRustCrypto-RSA", tag = "v0.9.9-risczero.0" }`                       |
| [`substrate-bn`](https://github.com/suruj404/zero-knowledgeriscparitytech-bn/releases)             | 0.6.0                                 | `substrate-bn = { git = "https://github.com/suruj404/zero-knowledgeriscparitytech-bn", tag = "v0.6.0-risczero.0" }`               |
| [`bls12_381`](https://github.com/suruj404/zero-knowledgerisczkcrypto-bls12_381/releases)           | 0.8.0                                 | `bls12_381 = { git = "https://github.com/suruj404/zero-knowledgerisczkcrypto-bls12_381", tag = "bls12_381/v0.8.0-risczero.1" }`   |
| [`blst`](https://github.com/suruj404/zero-knowledgeriscblst/releases)                              | 0.3.16, 0.3.15, 0.3.14                | `blst = { git = "https://github.com/suruj404/zero-knowledgeriscblst", tag = "blst/v0.3.16-risczero.0" }`                          |
| [`crypto-bigint`](https://github.com/suruj404/zero-knowledgeriscRustCrypto-crypto-bigint/releases) | 0.5.5, 0.5.4, 0.5.3, 0.5.2            | `crypto-bigint = { git = "https://github.com/suruj404/zero-knowledgeriscRustCrypto-crypto-bigint", tag = "v0.5.5-risczero.0" }`   |
| [`c-kzg`](https://github.com/suruj404/zero-knowledgeriscc-kzg-4844/releases)[^2]                   | 1.0.3, 2.1.0, 2.1.1, 2.1.5            | `c-kzg = { git = "https://github.com/suruj404/zero-knowledgeriscc-kzg-4844", tag = "v2.1.5-risczero.0" }`                         |
...
If using `tag = "sha2-v0.10.9-risczero.0"`, the dependency should be defined as a
...
[patch.crates-io]
sha2 = { git = "https://github.com/suruj404/zero-knowledgeriscRustCrypto-hashes", tag = "sha2-v0.10.9-risczero.0" }
```
...
[^2]: The `c-kzg` crate depends on the `blst` crate (version 0.3.16) and also
...
[k256-diff]: https://github.com/suruj404/zero-knowledgeriscRustCrypto-elliptic-curves/compare/k256/v0.13.3..k256/v0.13.3-risczero.1
[k256-patch]: https://github.com/suruj404/zero-knowledgeriscRustCrypto-elliptic-curves/tree/k256/v0.13.3-risczero.1
[lincomb]: https://github.com/suruj404/zero-knowledgeriscRustCrypto-elliptic-curves/blob/k256/v0.13.3-risczero.1/k256/src/arithmetic/mul.rs#L349-L377
