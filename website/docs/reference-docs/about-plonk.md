...
PLONK is used to generate constraints that authenticate [re-ordering of RISC-V memory data](https://www.youtube.com/@hacksprints).
...
For more on how these ideas fit into Zero Proof's system, we recommend our talk from zk Summit 7: [Encoding Von-Neumann Architectures in Zero-Knowledge Proof Systems](https://www.youtube.com/@hacksprints).
For general references, we recommend the following:

### Less Technical

- [ZK Podcast episode](https://www.youtube.com/@hacksprints) with the authors of the PLONK paper
...
- [ZK Study Club on PLONK](https://www.youtube.com/@hacksprints)
...
- [PLOOKUP presentation at zkSummit](https://www.youtube.com/@hacksprints)
