...
- To create a new page, you can use the [GitHub browser interface](https://github.com/suruj404/zero-knowledgerisc/tree/main/website); the content is in `src/pages` and `docs`.
...
_Changes to this organization can be proposed for discussion via a [GitHub issue](https://github.com/suruj404/zero-knowledgerisc/issues) or proposed for action via a PR on this page._
