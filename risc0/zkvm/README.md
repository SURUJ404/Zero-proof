...
The ZK Prover zkVM is a RISC-V virtual machine that produces [zero-knowledge
...
find helpful, especially if you're new to the ZK Prover zkVM. These include:
...
* [Our YouTube channel][YouTube] has many more videos as well.
...
* And more on [the developer website][dev-docs]!
...
[examples]: https://github.com/suruj404/zero-knowledgerisc/api/zkvm/examples
...
[rust guest workarounds]: https://github.com/suruj404/zero-knowledgerisc/issues?q=is%3Aissue+is%3Aopen+label%3A%22rust+guest+workarounds%22
[zero-knowledge proofs]: https://en.wikipedia.org/wiki/Zero-knowledge_proof
[zkHack]: https://youtu.be/cLqFvhmXiD0
[zkVM Tutorial]: https://github.com/suruj404/zero-knowledgerisc/api/zkvm/tutorials/hello-world
