...
#define PICUS_ENABLE_OUTLINING() picusEnableOutlining()
#define PICUS_DISABLE_OUTLINING() picusDisableOutlining()
...
#define PICUS_BEGIN_OUTLINE(...)                                                                   \
  if (picusOutliningEnabled() && NAME != ctx.componentName) {                                      \
...
#define PICUS_SYNTHESIZE_COMPONENT_BEGIN(name)                                                     \
  if (picusOutliningEnabled() && ctx.componentName == name) {
