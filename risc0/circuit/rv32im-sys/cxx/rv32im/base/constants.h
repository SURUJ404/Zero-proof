...
CONSTANT uint32_t P2_ZEROS_ADDR = 0xffff0280;
CONSTANT uint32_t P2_ZEROS_WORD = P2_ZEROS_ADDR / 4;
CONSTANT uint32_t P2_TRASH_ADDR = 0xffff02a0;
CONSTANT uint32_t P2_TRASH_WORD = P2_TRASH_ADDR / 4;
...
CONSTANT uint32_t MAX_ACCUM_PER_ROW = 144;
