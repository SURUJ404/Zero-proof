...
__device__ void step_Top_14(ExecContext& ctx, MutableBuf arg0) {
  ...
  set(ctx, arg0, 12, get(ctx, arg0, 12, 1));
  // ControlState(zirgen/circuit/keccak/top.zir:297)
  set(ctx, arg0, 13, (get(ctx, arg0, 13, 1) + Val(1)));
  return;
}
__device__ void step_Top_30(ExecContext& ctx, MutableBuf arg0) {
  ...
  // builtin Isz
  Val x2405 = isz((Val(3) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 949, x2405);
  // builtin Isz
  Val x2406 = isz((Val(4) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 950, x2406);
  // builtin Isz
  Val x2407 = isz((Val(5) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 951, x2407);
  // builtin Isz
  Val x2408 = isz((Val(6) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 952, x2408);
  // builtin Isz
  Val x2409 = isz((Val(7) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 953, x2409);
  // builtin Isz
  Val x2410 = isz((Val(8) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 954, x2410);
  // builtin Isz
  Val x2411 = isz((Val(9) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 955, x2411);
  // builtin Isz
  Val x2412 = isz((Val(10) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 956, x2412);
  // builtin Isz
  Val x2413 = isz((Val(11) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 957, x2413);
  // builtin Isz
  Val x2414 = isz((Val(12) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 958, x2414);
  // builtin Isz
  Val x2415 = isz((Val(13) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 959, x2415);
  // builtin Isz
  Val x2416 = isz((Val(14) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 960, x2416);
  // builtin Isz
  Val x2417 = isz((Val(15) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 961, x2417);
  // builtin Isz
  Val x2418 = isz((Val(16) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 962, x2418);
  // builtin Isz
  Val x2419 = isz((Val(17) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 963, x2419);
  // builtin Isz
  Val x2420 = isz((Val(18) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 964, x2420);
  // builtin Isz
  Val x2421 = isz((Val(19) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 965, x2421);
  // builtin Isz
  Val x2422 = isz((Val(20) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 966, x2422);
  // builtin Isz
  Val x2423 = isz((Val(21) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 967, x2423);
  // builtin Isz
  Val x2424 = isz((Val(22) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 968, x2424);
  // builtin Isz
  Val x2425 = isz((Val(23) - x801));
  // builtin NondetReg
  // NondetBitReg(zirgen/circuit/keccak/bits.zir:13)
  set(ctx, arg0, 969, x2425);
  // builtin Add
  // RoundToArray(zirgen/circuit/keccak/keccak.zir:119)
  Val x2426 = ((get(ctx, arg0, 948, 0) + get(ctx, arg0, 949, 0)) + get(ctx, arg0, 952, 0));
  Val x2427 =
      (((x2426 + get(ctx, arg0, 953, 0)) + get(ctx, arg0, 959, 0)) + get(ctx, arg0, 960, 0));
  Val x2428 =
      (((x2427 + get(ctx, arg0, 961, 0)) + get(ctx, arg0, 962, 0)) + get(ctx, arg0, 963, 0));
  Val x2429 =
      (((x2428 + get(ctx, arg0, 965, 0)) + get(ctx, arg0, 966, 0)) + get(ctx, arg0, 967, 0));
  Val x2430 = (x2429 + get(ctx, arg0, 969, 0));
  // builtin Sub
  // BitXor(zirgen/circuit/keccak/bits.zir:34)
  // Iota(zirgen/circuit/keccak/keccak.zir:128)
  Val x2431 = ((x2430 + x865) - ((x2430 * Val(2)) * x865));
  // builtin NondetReg
  // Reg(<preamble>:5)
  // TopState(zirgen/circuit/keccak/top.zir:33)
  set(ctx, arg0, 14, x803);
  set(ctx, arg0, 15, x805);
  set(ctx, arg0, 16, x807);
  set(ctx, arg0, 17, x809);
  set(ctx, arg0, 18, x811);
  set(ctx, arg0, 19, x813);
  set(ctx, arg0, 20, x815);
  set(ctx, arg0, 21, x817);
