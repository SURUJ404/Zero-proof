...
repository](https://github.com/suruj404/zero-knowledgerisc-rust-starter). In that repository,
`risc0-build` is used in the [`methods`
directory](https://github.com/suruj404/zero-knowledgerisc-rust-starter/tree/main/methods).
